  ...
  return (
    <div className="relative isolate flex items-center h-12 overflow-hidden bg-[#0A0A0A] border-b border-white/5">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%232d63ff' fill-opacity='0.15' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='1'/%3E%3C/g%3E%3C/svg%3E")`,
          backgroundSize: '20px 20px'
        }}
      />
      <div 
        className="absolute inset-0 opacity-20 pointer-events-none"
        style={{ background: 'linear-gradient(90deg, transparent, rgba(45,99,255,0.12) 20%, rgba(34,197,94,0.1) 80%, transparent)' }}
      />
