    ...
    return (
        <div className="flex flex-col gap-4 text-center mt-9 mb-10 w-full">
            <div className="flex flex-col items-center justify-center gap-12 max-w-xl mx-auto w-full">
                <div
                    className={cn(
                        'relative grid w-[90%] md:w-full grid-cols-1 md:grid-cols-3 gap-3 md:gap-1 p-1 px-8 md:px-1 shadow-sm md:rounded-full border md:border-black/5',
                        theme === 'light' ? 'bg-white' : 'bg-[#19191C] border-white/5'
                    )}
                >
                    {navItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    'flex h-10 cursor-pointer items-center justify-center gap-2 rounded-full border border-transparent px-4 font-medium transition-colors text-sm',
                                    isActive
