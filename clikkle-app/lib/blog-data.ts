...
export const authors: Author[] = [
  ...
  },
  {
    ...
    slug: 'ebenezer-don',
    role: 'Developer Advocate',
    avatar: '/clikkle/images/avatars/ebenezer.png',
    href: '/blog/author/ebenezer-don',
  },
  {
    name: 'Chirag Aggarwal',
    slug: 'chirag-aggarwal',
    role: 'Software Engineer',
    avatar: '/clikkle/images/avatars/chirag.png',
    href: '/blog/author/chirag-aggarwal',
  },
  {
    name: 'Damodar Lohani',
    slug: 'damodar-lohani',
    role: 'Software Engineer',
    avatar: '/clikkle/images/avatars/damodar.png',
    href: '/blog/author/damodar-lohani',
  },
  {
    name: 'Darshan Pandya',
    slug: 'darshan-pandya',
    role: 'Software Engineer',
    avatar: '/clikkle/images/avatars/darshan.png',
    href: '/blog/author/darshan-pandya',
  },
  {
    name: 'Steven Nguyen',
    slug: 'steven',
    role: 'Developer Advocate',
    avatar: '/clikkle/images/avatars/steven.png',
    href: '/blog/author/steven',
  },
];
...
export const featuredPost: BlogPost = {
  ...
  date: '2026-03-17',
  cover: '/clikkle/images/blog/announcing-appwrite-arena/cover.png',
  timeToRead: 4,
  author: 'matej-baco',
...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    date: '2026-03-20',
    cover: '/clikkle/images/blog/appwrite-vs-cloudinary/cover.png',
    timeToRead: 7,
    author: 'aditya-oberai',
    category: 'product',
  ...
  },
  {
    ...
    date: '2026-03-20',
    cover: '/clikkle/images/blog/appwrite-vs-vercel-vs-netlify/cover.png',
    timeToRead: 7,
    author: 'aditya-oberai',
    category: 'product',
  ...
  },
  {
    ...
    date: '2026-03-19',
    cover: '/clikkle/images/blog/building-a-production-ready-backend-with-appwrite/cover.png',
    timeToRead: 5,
    author: 'atharva',
    category: 'tutorial',
  ...
  {
    title: 'Announcing Clikkle Sites: The open source Vercel alternative',
    description:
      "This is Clikkle's biggest release to date. Develop, deploy, and scale your applications directly from Clikkle with an all-in-one cloud platform.",
    date: '2025-05-19',
    cover: '/clikkle/images/blog/sites-announcement/sites-cover.png',
    timeToRead: 6,
    author: 'matej-baco',
    category: 'init',
    slug: 'announcing-clikkle-sites',
    href: '/blog/post/announcing-clikkle-sites',
  },
  {
    title: 'How to host SSR web apps on Clikkle Sites',
    description:
      'Learn how to deploy server-rendered applications with Clikkle Sites, with full control over dynamic rendering and framework-specific setups.',
    date: '2025-05-19',
    cover: '/clikkle/images/blog/host-ssr-web-cover.png',
    timeToRead: 6,
    author: 'ebenezer-don',
    category: 'init',
  ...
  },
  {
    ...
    description:
      'Clikkle Sites templates help you start faster, from e-commerce stores to documentation sites, with only a few clicks.',
    date: '2025-05-19',
    cover: '/clikkle/images/blog/sites-templates/templates-cover.png',
    timeToRead: 9,
    author: 'ebenezer-don',
    category: 'init',
  ...
  },
  {
    ...
    description:
      'Choosing how your web app renders content can affect performance and user experience. Learn how CSR, SSG, and SSR work and when to use each one.',
    date: '2025-05-19',
    cover: '/clikkle/images/blog/csr-ssg-ssr.png',
    timeToRead: 10,
    author: 'ebenezer-don',
    category: 'init',
    slug: 'csr-ssg-ssr',
  ...
  {
    title: 'Announcing hosting for Flutter web: deploy your Flutter web apps with Clikkle',
    description:
      'Clikkle Sites now supports Flutter web apps. Deploy your Flutter applications directly from your Clikkle project with seamless backend integration.',
    date: '2025-05-20',
    cover: '/clikkle/images/blog/hosting-flutter-web/cover.png',
    timeToRead: 5,
    author: 'steven',
    category: 'init',
  ...
  },
  {
    ...
    description: 'Learn the process of deploying the Flutter starter template on Clikkle Sites.',
    date: '2025-05-20',
    cover: '/clikkle/images/blog/flutter-starter-sites/cover.png',
    timeToRead: 5,
    author: 'aditya-oberai',
    category: 'init',
  ...
  },
  {
    ...
    description:
      'Dev Keys help you build without interruptions during local development, testing, and CI workflows.',
    date: '2025-05-21',
    cover: '/clikkle/images/blog/dev-keys.png',
    timeToRead: 6,
    author: 'chirag-aggarwal',
    category: 'init',
    slug: 'announcing-dev-keys',
    href: '/blog/post/announcing-dev-keys',
  },
  {
    title: 'Improve your Clikkle developer experience with Dev Keys',
    description:
      'Learn how you can create a Dev Key on Clikkle and use it in a web project to improve your developer experience.',
    date: '2025-05-21',
    cover: '/clikkle/images/blog/improve-devex-dev-keys/cover.png',
    timeToRead: 7,
    author: 'aditya-oberai',
    category: 'init',
  ...
  {
    title: 'Announcing HEIC and AVIF support: modern image formats now in Clikkle',
    description:
      'Clikkle Storage now supports HEIC and AVIF, giving you more tools to manage, transform, and serve images efficiently.',
    date: '2025-05-22',
    cover: '/clikkle/images/blog/new-image-formats.png',
    timeToRead: 6,
    author: 'damodar-lohani',
    category: 'init',
    slug: 'new-image-formats-avif-heic',
    href: '/blog/post/new-image-formats-avif-heic',
  },
  {
    title: 'How to use AVIF in Clikkle Storage',
    description:
      'Learn how to use AVIF, a modern image format with better compression and strong image quality, in Clikkle Storage.',
    date: '2025-05-22',
    cover: '/clikkle/images/blog/avif-in-storage/cover.png',
    timeToRead: 6,
    author: 'ebenezer-don',
    category: 'init',
  ...
  },
  {
    ...
    description:
      'File Tokens make sharing files from Clikkle simple, secure, and hassle-free, so you can collaborate externally without compromising control.',
    date: '2025-05-23',
    cover: '/clikkle/images/blog/file-tokens.png',
    timeToRead: 5,
