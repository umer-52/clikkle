...
layout: tutorial
title: Add database
description: Connect a database to your React Native application using Clikkle Web SDK.
step: 6
---
In this step, you'll set up a database to store ideas in Clikkle, configure permissions, then create a
...
```client-react-native
import { ID, Permission, Role, Query } from "react-native-clikkle";
