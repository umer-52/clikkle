...
description: Learn to build a React Native app with no backend code using an Clikkle backend.
step: 1
difficulty: beginner
back: /docs/tutorials
readtime: 10
...
In this tutorial, you will build Idea tracker with Clikkle and React Native.
