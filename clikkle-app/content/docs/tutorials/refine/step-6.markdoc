...
description: Add database queries and CRUD pages using Clikkle in your Refine application.
step: 6
---
...
## List page {% #list-page %}
 ...
 First, create a listing page to show Clikkle API data in a table by copying the code below into `src/pages/posts` and saving it as `list.tsx`.
...
## Create page {% #create-page %}
 ...
 Create a new record page for the Clikkle API by copying the following code and saving it as `create.tsx`.
