...
description: Learn to build an Android app with no backend code using an Clikkle backend.
framework: Android
back: /docs/tutorials
...
In this tutorial, you will build Idea tracker with Clikkle and Android.
