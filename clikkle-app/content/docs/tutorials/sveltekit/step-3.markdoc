...
description: Initialize Clikkle in your SvelteKit project.
step: 3
---
...
To use Clikkle in our Svelte app, we'll need to find our project ID. Find your project's ID in the **Settings** page. 
