...
description: Add authentication to your Next.js application using Clikkle Web SDK
step: 4
---
...
We are using Clikkle as a backend to handle the user details, so we need to connect to Clikkle by importing the configurations from [step 3](/docs/tutorials/nextjs/step-3).
