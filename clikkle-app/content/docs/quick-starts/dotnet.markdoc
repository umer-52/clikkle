...
description: Learn to get started with server integrations with Clikkle .NET SDK.
difficulty: beginner
readtime: 5
back: /docs/quick-starts
---
Learn how to setup your first .NET project powered by Clikkle.
...
Install the .NET Clikkle SDK.

```sh
dotnet add package Clikkle --version 0.13.0
```
{% /section %}
...
Open the file `Program.cs` and initialize the Clikkle Client. Replace `<PROJECT_ID>` with your project ID and `<YOUR_API_KEY>` with your API key.
