...
description: Discover how to leverage Clikkle's powerful backend to help you build React Native apps for iOS, Android and other native platforms.
difficulty: beginner
readtime: 10
back: /docs/quick-starts
---

Learn how to setup your first React Native project powered by Clikkle.
...
Install the Clikkle SDK for React Native and required dependencies.

```sh
npx expo install react-native-clikkle react-native-url-polyfill
```
{% /section %}

{% section #step-4 step=4 title="Implement Clikkle" %}
...
This imports and initializes Clikkle and defines some basic authentication methods.

```client-react-native
import { StatusBar } from 'expo-status-bar';
import { StyleSheet, Text, View, TextInput, TouchableOpacity } from 'react-native';
import { Client, Account, ID, Models } from 'react-native-clikkle';
...
With `Client` and `Account` service initialized, you can now use them to make your first requests to Clikkle.
...
{% arrow_link
   href="https://github.com/clikkle/playground-for-react-native" %}
