...
---
Learn how to setup your first Dart project powered by Clikkle.
...
Install the Dart Clikkle SDK.

```sh
dart pub add dart_clikkle:16.0.0
```
{% /section %}
...
Open `bin/my_app.dart` and initialize the Clikkle Client. Replace `<PROJECT_ID>` with your project ID and `<YOUR_API_KEY>` with your API key.
