...
layout: article
title: Payload
description: Understand the structure of Clikkle Realtime subscription payloads and learn how to work with the response data.
---
...
* events
* string[]
* The [Clikkle events](/docs/advanced/platform/events) that triggered this update.
---
* channels
* string[]
