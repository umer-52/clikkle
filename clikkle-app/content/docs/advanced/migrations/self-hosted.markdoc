...
description: Migrate to Clikkle from self-hosted platforms seamlessly. Learn how to move your applications and data to Clikkle for enhanced flexibility and control.
difficulty: beginner
readtime: 20
---
...
2. Your self-hosted Clikkle project must be accessible from the internet for the migration to work.
...
2. Click **Deploy to Cloud**, you will be redirected to Clikkle Cloud.

3. You will complete the migration on Clikkle Cloud.

{% /section %}

{% section #continue-on-cloud step=3 title="Continue on Clikkle Cloud" %}

1. Once redirected to Clikkle Cloud, you'll be prompted to select an organization and a project. You can migrate to an existing project or create a new one.

2. Select the data you wish to migrate. You can choose among accounts, databases, rows, files, functions, and sites.

3. Click **Start migration** to start the migration process. You do not need to keep the Clikkle Console open through the process.
