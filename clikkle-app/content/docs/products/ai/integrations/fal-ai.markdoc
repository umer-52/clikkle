...
description: Learn how to integrate fal.ai into your Clikkle project.
...
This tutorial will guide you through the process of setting up the fal.ai API to generate an image using the SDXL model and integrating it into your Clikkle project.
...
With the function complete, deploy it to Clikkle by pushing the changes to your repository.
...
![Testing the function](/clikkle/images/docs/ai/integrations/fal-ai/demo.png)
{% /section %}
