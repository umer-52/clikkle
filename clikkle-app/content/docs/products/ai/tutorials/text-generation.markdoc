...
description: Implement text generation into your app with Clikkle and Hugging Face.
difficulty: intermediate
readtime: 15
---

Learn to setup an Clikkle Function utilizing text generation with Hugging Face.
