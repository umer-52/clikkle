...
description: Optimize image storage and processing with Clikkle. Explore image resizing, transformations, and manipulation to deliver rich media experiences in your apps.
---

Clikkle provides utilities to manipulate images for previewing images in your apps.

Clikkle Storage's [preview endpoint](/docs/references/cloud/client-web/storage#getFilePreview) let you manipulate resolution, add borders and the border-radius, add background-color, set the opacity for the image, and get the image in the appropriate output format.
...
The Clikkle Storage also allows you to change the format and compression of your images for network transfer optimization and to help you speed your application. You can do all that without caring about how the image was originally uploaded.

{% info title="Caching" %}
When manipulating images in Clikkle, the resulting images are cached by Clikkle and your browser.
