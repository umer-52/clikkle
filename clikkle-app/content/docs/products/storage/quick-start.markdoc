...
description: Get started quickly with Clikkle Storage. Follow step-by-step instructions to set up storage, upload files, and integrate cloud storage into your projects
difficulty: beginner
readtime: 5
---
...
You can create a bucket in the Clikkle Console by navigating to **Storage** > **Create bucket**.
