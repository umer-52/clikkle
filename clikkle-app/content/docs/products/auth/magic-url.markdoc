...
description: Add magic URL to your authentication in Clikkle. Explore the convenience of passwordless login and email-based authentication using magic links.
---
