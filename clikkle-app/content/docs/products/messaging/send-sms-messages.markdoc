...
description: Send SMS messages to your users using Clikkle Messaging.
---
You can send custom SMS messages to your app's users using Clikkle Messaging and a connected SMTP service.
This guide takes you through the implementation path of adding SMS messaging to your app.

# Add a provider {% #add-a-provider %}
Clikkle supports [Twilio](/docs/products/messaging/twilio/),
...
{% only_dark %}
![Add a SMTP provider](/clikkle/images/docs/messaging/providers/twilio/dark/provider.png)
{% /only_dark %}
{% only_light %}
![Add a SMTP provider](/clikkle/images/docs/messaging/providers/twilio/provider.png)
{% /only_light %}
