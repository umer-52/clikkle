...
layout: article
title: Textmagic
description: Send SMS messages to your Clikkle users using Textmagic and Clikkle Messaging.
back: /docs/
---
...
{% only_dark %}
![Add a Textmagic provider](/clikkle/images/docs/messaging/providers/textmagic/dark/provider.png)
{% /only_dark %}
{% only_light %}
![Add a Textmagic provider](/clikkle/images/docs/messaging/providers/textmagic/provider.png)
{% /only_light %}
...
In the **Configure** step, you will need to provide details from your Textmagic dashboard to connect your Clikkle project.
...
{% only_dark %}
![Create an SMS message](/clikkle/images/docs/messaging/messages/dark/create-sms-message.png)
{% /only_dark %}
{% only_light %}
![Create an SMS message](/clikkle/images/docs/messaging/messages/create-sms-message.png)
{% /only_light %}
