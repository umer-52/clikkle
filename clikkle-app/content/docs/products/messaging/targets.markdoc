...
Push notifications require configuration on both the Clikkle platform and your client app's code.
...
{% only_dark %}![Enable Push Notification in XCode](/clikkle/images/docs/messaging/targets/dark/xcode-enable-pn.png){% /only_dark %}{% only_light %}![Enable Push Notification in XCode](/clikkle/images/docs/messaging/targets/xcode-enable-pn.png){% /only_light %}
{% /tabsitem %}
...
1. Add push notification capability to your app by clicking your root-level app in XCode > **Signing & Capabilities** > {% icon icon="plus" size="m" /%} Capabilities > Search for **Push Notifications**.
{% only_dark %}
![Enable Push Notification in XCode](/clikkle/images/docs/messaging/targets/dark/xcode-enable-pn.png)
{% /only_dark %}
{% only_light %}
![Enable Push Notification in XCode](/clikkle/images/docs/messaging/targets/xcode-enable-pn.png)
{% /only_light %}
