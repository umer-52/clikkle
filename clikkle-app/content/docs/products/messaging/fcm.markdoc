...
back: /docs/
---
Firebase Cloud Messaging (FCM) lets you send push notifications to your iOS, Android, and web apps through Clikkle Messaging.
...
{% only_dark %}
![Add a FCM provider](/clikkle/images/docs/messaging/providers/fcm/dark/provider.png)
{% /only_dark %}
{% only_light %}
![Add a FCM provider](/clikkle/images/docs/messaging/providers/fcm/provider.png)
{% /only_light %}
...
In the **Configure** step, you will need to provide details from your Firebase console to connect your Clikkle project.
...
{% only_dark %}
![FCM admin key](/clikkle/images/docs/messaging/providers/fcm/dark/admin-key.png)
{% /only_dark %}
{% only_light %}
![FCM admin key](/clikkle/images/docs/messaging/providers/fcm/admin-key.png)
{% /only_light %}
