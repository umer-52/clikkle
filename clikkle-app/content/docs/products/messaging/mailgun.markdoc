...
layout: article
title: Mailgun
description: Send emails to your Clikkle users using Mailgun and Clikkle Messaging.
back: /docs/
---
...
In the **Configure** step, you will need to provide details from your Mailgun dashboard to connect your Clikkle project.


{% only_dark %}
![Configure SMTP provider](/clikkle/images/docs/messaging/providers/mailgun/dark/configure-mailgun.png)
{% /only_dark %}
{% only_light %}
![Configure SMTP provider](/clikkle/images/docs/messaging/providers/mailgun/configure-mailgun.png)
{% /only_light %}
