...
layout: article
title: MSG91
description: Send SMS messages to your Clikkle users using MSG91 and Clikkle Messaging.
back: /docs/
---
...
{% only_dark %}
![Add a MSG91 provider](/clikkle/images/docs/messaging/providers/msg91/dark/provider.png)
{% /only_dark %}
{% only_light %}
![Add a MSG91 provider](/clikkle/images/docs/messaging/providers/msg91/provider.png)
{% /only_light %}
...
In the **Configure** step, you will need to provide details from your MSG91 dashboard to connect your Clikkle project.
