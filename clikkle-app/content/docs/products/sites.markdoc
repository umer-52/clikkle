...
layout: article
title: Sites
description: Clikkle Sites is your gateway to scalable web applications. Explore our complete guide to building and deploying websites effortlessly.
---

Clikkle Sites empowers developers to host and manage web applications seamlessly within the Clikkle ecosystem. Clikkle Sites provides a fast, scalable, and secure way to deploy web apps directly from source control, allowing for quick iterations and live updates. Each site has a dedicated URL, runs within its own isolated container, and can be configured with custom domains and environment variables.

Clikkle Sites leverages the [Clikkle Network](/docs/products/network) infrastructure to enhance your sites' performance and reliability. Your deployed sites automatically benefit from global content distribution across strategic edge locations, reducing latency and improving load times, while also gaining advanced security features including DDoS protection, Web Application Firewall (WAF), and TLS encryption.

# Getting started

Clikkle Sites lets you host any web application with ease. However, to make this process even simpler, you can begin by exploring starter kits developed by the Clikkle team or leverage a pre-configured template with built-in integrations to implement essential features.

{% only_dark %}
![Create first site](/clikkle/images/docs/sites/dark/create-first-site.png)
{% /only_dark %}
{% only_light %}
![Create first site](/clikkle/images/docs/sites/create-first-site.png)
{% /only_light %}
...
Looking to migrate existing web applications from other hosting platforms to Clikkle Sites? Find detailed migration guides for various platforms:
