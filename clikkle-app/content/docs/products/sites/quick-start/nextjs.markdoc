---
layout: article
title: Deploy a Next.js app to Clikkle Sites
description: Learn how to setup and deploy Next.js apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create Next.js app" %}

{% info title="Full Next.js support available" %}
Clikkle Sites fully supports Next.js out of the box. Unlike other non-Vercel hosting services, the Clikkle Edge runs in a container-based environment for Node.js (and soon Bun as well), managed by a control plane that automatically scales your app as needed. This means all Next.js features work without any extra configuration or the OpenNext adapter.
{% /info %}

First, you must either create a Next.js app or setup the [Next.js starter template](https://github.com/clikkle/templates-for-sites).
...
Head to the [Clikkle Console](https://cloud.clikkle.io).

{% only_dark %}
![Create Clikkle project](/clikkle/images/docs/quick-starts/dark/create-project.png)
{% /only_dark %}
{% only_light %}
![Create Clikkle project](/clikkle/images/docs/quick-starts/create-project.png)
{% /only_light %}
...
Head to the **Sites** page in your Clikkle project, click on the **Create site** button, and select **Connect a repository**.
