---
layout: article
title: Deploy a Nuxt app to Clikkle Sites
description: Learn how to setup and deploy Nuxt apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create Nuxt app" %}

First, you must either create a Nuxt app or setup the [Nuxt starter template](https://github.com/clikkle/templates-for-sites).
