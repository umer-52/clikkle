---
layout: article
title: Deploy a SvelteKit app to Clikkle Sites
description: Learn how to setup and deploy SvelteKit apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create SvelteKit app" %}

First, you must either create a SvelteKit app or setup the [SvelteKit starter template](https://github.com/clikkle/templates-for-sites).
