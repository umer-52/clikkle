...
import { HeroesCarousel } from './heroes-carousel';
import './heroes.css';

/** `src/routes/heroes/+page.svelte` — same Typeform target (swap for Clikkle form when ready). */
const HEROES_APPLY_URL = 'https://7nxwryuitoy.typeform.com/heroes-apply';
    ...
    return (
        <li>
            <div className="web-card is-white light h-full">
                <div className="web-social-item heroes-pg-social-item flex h-full flex-col">
                    <div className="flex justify-between gap-4">
                        <div className="web-user-box">
                            <img className="web-user-box-image" src={hero.avatar} alt="" />
                            <div className="web-user-box-name text-sub-body font-medium text-primary">{hero.name}</div>
                            <div className="web-user-box-username text-sub-body">{hero.role}</div>
                        </div>
                    </div>
                    <p className="text-sub-body text-secondary mt-5 font-medium flex-1">{hero.bio}</p>
...
export default function HeroesPage() {
    return (
        <main className="min-w-0 overflow-x-clip">
            <div className="web-big-padding-section heroes-pg-root w-full min-w-0 max-w-full">
                {/* ══════════════════════  HERO  ══════════════════════ */}
                <div className="heroes-pg-hero-band py-10">
                    <div className="web-big-padding-section-level-2">
                        <section className="heroes-pg-hero web-u-padding-block-end-0 container">
                            <div>
                            ...
                            <div className="heroes-pg-hero-visual">
                                <img className="heroes-pg-hero-illustration" src="/clikkle/images/heroes/bg.png" alt="" />
                            </div>
                        </section>
                    </div>
                </div>
                ...
                <div className="py-10">
                    <div className="web-big-padding-section-level-2">
                        <section className="container">
                            <div className="web-hero is-center web-u-max-width-800 heroes-pg-about">
                                <h2 className="text-title font-aeonik-pro text-primary">
                                    About Clikkle Heroes
                                </h2>
                                <div>
                                    <p className="text-sub-body font-medium text-secondary">
                ...
                <div className="web-white-section light relative py-10">
                    <div className="web-big-padding-section-level-2">
                        <div className="container">
                            <div className="web-hero">
                                <div className="text-display font-aeonik-pro text-primary">
                                    Meet our Heroes
                                </div>
                            </div>
                    ...
                    {/* Carousel — `use:infiniteScroll` + `[data-animated]` in `+page.svelte` */}
                    <div className="web-big-padding-section-level-2 overflow-hidden">
                        <HeroesCarousel />
                    </div>
                ...
                <div className="heroes-pg-footer-wrapper relative pt-10">
                    <img
                        src="/clikkle/images/heroes/bg-pre.png"
                        alt=""
                        className="heroes-pg-footer-bg absolute"
                    />
                    <div className="web-big-padding-section-level-2 relative">
                        ...
                        <div className="web-big-padding-section-level-2 relative">
                            <div className="relative container">
                                <SiteFooter footerNavNoTopBorder noOuterContainer />
                            </div>
                        </div>
                    </div>
                </div>
