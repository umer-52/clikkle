                    ...
                    <div className="col-span-full flex flex-col gap-6 lg:col-span-5">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-2">
                            <Link
                                ...
                                className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 h-9 py-2 w-full md:w-auto bg-white text-black hover:bg-white/90 px-8 shadow"
                            >
                                Start for free
                            </Link>
                            <Link
                                href="/docs/products/sites"
                                className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 h-9 py-2 w-full md:w-auto bg-secondary text-secondary-foreground hover:bg-secondary/80 px-8 shadow-sm"
                            >
                                Read the docs
                            </Link>
                        </div>
