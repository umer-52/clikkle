...
export function DocsFooter() {
  ...
  return (
    <footer className="mt-8 relative text-sm border-t border-white/10 pt-8 pb-12">
      <div className="flex flex-col xl:flex-row items-center justify-between gap-6">
        
        {/* Social Icons */}
        <ul className="flex flex-wrap items-center justify-center gap-1.5">
          <SocialLink href="/discord" icon={<DiscordIcon />} label="Discord" />
          <SocialLink href="https://github.com/appwrite" icon={<GithubIcon />} label="Github" />
          <SocialLink href="https://twitter.com/intent/follow?screen_name=appwrite" icon={<XIcon />} label="Twitter" />
          <SocialLink href="https://linkedin.com/company/appwrite" icon={<LinkedInIcon />} label="LinkedIn" />
          <SocialLink href="https://youtube.com/c/appwrite?sub_confirmation=1" icon={<YouTubeIcon />} label="YouTube" />
          <SocialLink href="https://app.daily.dev/squads/appwrite" icon={<DailyDevIcon />} label="Daily.dev" />
          <SocialLink href="https://bsky.app/profile/appwrite.io" icon={<BlueskyIcon />} label="Bluesky" />
          <SocialLink href="https://tiktok.com/@appwrite" icon={<TikTokIcon />} label="Tiktok" />
          <SocialLink href="https://instagram.com/appwrite.io" icon={<InstagramIcon />} label="Instagram" />
        </ul>

        {/* Theme Dropdown */}
        <div className="flex items-center">
          <button className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 hover:bg-white/10 transition-colors">
            <Moon size={14} className="text-white/80" />
            <span className="text-white/80 font-medium">Dark</span>
            <svg className="w-4 h-4 ml-1 text-white/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg>
          </button>
        </div>

        {/* Links & Copyright */}
        <div className="flex items-center gap-6 text-white/60">
          <Link href="/discord" className="hover:text-white transition-colors">Support</Link>
          <Link href="https://appwrite.online" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">Status</Link>
          <span className="hidden sm:inline">Copyright © {year} Clikkle</span>
        </div>
        
        <div className="sm:hidden text-white/50 w-full text-center">
  ...
  return (
    <li>
      <a
        ...
        className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-white/70 transition-colors hover:bg-white/15 hover:text-white"
      >
        {icon}
      </a>
    </li>
