    ...
    <div className="flex min-h-[100vh] flex-col items-center justify-center gap-12 bg-[#EDEDF0] py-20">
      ...
      <div className="flex flex-col items-center gap-4 px-4">
        ...
        <a
          ...
          className="mt-2 flex items-center justify-center rounded-full border border-[#CDCDCF] bg-white px-6 py-2.5 text-sm font-semibold text-[#19191c] transition-colors hover:bg-[#f5f5f5]"
        >
