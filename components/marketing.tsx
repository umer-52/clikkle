    ...
    <section className="py-24 md:py-32 bg-[var(--bg-primary)] overflow-hidden relative">
      ...
      <div className="shell relative z-10 text-center max-w-3xl mx-auto">
        ...
        <Reveal delay={0.2} className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/register" className="button-primary w-full sm:w-auto text-lg py-4 px-10 rounded-full shadow-[var(--shadow-3)]">
            Start building
          </Link>
          <Link href="/contact" className="button-secondary w-full sm:w-auto text-lg py-4 px-10 rounded-full">
            Talk to sales
          </Link>
        </Reveal>
      </div>
