...
export function SiteHeader() {
  ...
  const navLinks = [
    ...
    { label: 'Customers', href: '/customers', match: (p: string) => p.startsWith('/customers') },
    { label: 'Enterprise', href: '/enterprise', match: (p: string) => p.startsWith('/enterprise') }
  ];
    ...
    <>
      <header className={`aw-header ${isScrolled ? "aw-header-scrolled" : ""}`}>
        <div className="aw-header-shell">
          <Link className="aw-logo-link aw-focus-ring flex items-center gap-2 text-xl font-bold tracking-tight text-white hover:text-white/90 transition-colors" href="/" aria-label="Clikkle home">
          ...
          <nav className="aw-header-nav" aria-label="Primary navigation">
            {navLinks.map((link) => {
          ...
          <div className="aw-header-actions">
            ...
            >
              <Star className="aw-button-icon" aria-hidden="true" />
            ...
            <button
              className="aw-menu-button aw-focus-ring"
              type="button"
        ...
        >
          <div className="aw-mobile-panel-header">
            ...
            <button
              ...
              onClick={() => setIsMobileNavOpen(false)}
            >
              <X className="aw-button-icon" aria-hidden="true" />
            </button>
          </div>
