                    ...
                    <div key={i} className="flex items-center gap-3 p-3">
                        {email.open ? (
                            <div className="border-[#656569] bg-white/5 flex size-6 shrink-0 items-center justify-center rounded-[6px] border">
                                <Image src="/images/products/auth/envelope-open.svg" width={16} height={16} alt="Open envelope" />
                            </div>
                        ) : (
                            <div className="border-[#FD366E] bg-[#FD366E]/10 flex size-6 shrink-0 items-center justify-center rounded-[6px] border">
                                <Image src="/images/products/auth/envelope-closed.svg" width={16} height={16} alt="Closed envelope" />
                            </div>
                        )}
                ...
                {[1, 4, 8, 2, 9, 3].map((number, i) => (
                    <div
                        ...
                        className={cn(
                            ...
                            {
                                'border-[#FD366E] shadow-[#FD366E]/10 shadow-md': i === 3
                            }
                        )}
                    >
                        <span>{number}</span>
    ...
    return (
        <div className="right-0 flex w-[120px] flex-col gap-4">
            <div className="relative z-20 flex size-20 items-center justify-center overflow-hidden rounded-2xl backdrop-blur-2xl border border-white/10 bg-white/5">
                <Image src="/images/products/auth/identity-bg.png" fill className="absolute inset-0 object-cover opacity-50" alt="" />
