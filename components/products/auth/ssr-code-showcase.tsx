...
export async function createSessionClient() {
    ...
    sveltekit: {
        language: 'SvelteKit',
        code: `import { Client, Account } from 'node-appwrite';
...
const platforms = [
    {
        ...
        image: '/images/products/auth/platforms/next.svg'
    },
    {
        name: 'Svelte',
        href: '/docs/quick-starts/sveltekit',
        image: '/images/products/auth/platforms/svelte.svg'
    },
    {
        name: 'Nuxt',
        href: '/docs/quick-starts/nuxt',
        image: '/images/products/auth/platforms/nuxt.svg'
    }
];
