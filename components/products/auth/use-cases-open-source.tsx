                        ...
                        <div className="flex items-center gap-2">
                            {platforms.map((platform) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Image
                                            src={`/images/products/auth/platforms/${platform.file}`}
                        ...
                        <div className="flex items-center gap-2 relative">
                            {migrations.map((migration) => (
                                <div key={migration.name} className="flex size-10 items-center justify-center rounded-lg bg-black/5 border border-black/10 z-10">
                                    <Image
                                        src={`/images/products/auth/platforms/${migration.file}`}
                                        alt={migration.name}
                                        width={24}
                                        height={24}
                                    />
                            ...
                            <div className="-mr-2 h-px w-24 flex-1 bg-gradient-to-r from-black/10 to-[#FD366E] z-0"></div>

                            <div className="flex size-14 items-center justify-center rounded-lg border border-[#FD366E] bg-white shadow-[0px_0px_8px_rgba(253,_54,_110,_0.24)] z-10 backdrop-blur-md">
                                <Image
                ...
                <div className="container overflow-x-hidden">
                    <div className="mx-auto mb-20 flex max-w-2xl flex-col items-center gap-y-4 text-center">
                        <h2 className="md:text-display text-title text-primary font-aeonik-pro text-[#19191C] leading-tight">
                            ...
                            <div className="relative inline-flex bg-[linear-gradient(-146deg,_#FD376F,_#19191D_47%,_#19191D)] bg-clip-text text-transparent border-b border-dashed border-[#FD366E]">
                                <span className="text-[#FD366E] relative">
                                    {alternativePlatforms[activeIndex]}
                                    <div className="animate-caret-blink absolute top-1/2 -right-3 bottom-0 block h-[75%] w-px -translate-y-1/2 bg-[#FD366E]"></div>
                                </span>
                            </div>
                        </h2>
                        ...
                        <div className="mx-auto mt-4 flex w-full flex-col items-center justify-center gap-2 md:flex-row">
                            <a href="https://github.com/appwrite" className="button-secondary h-10 !w-full md:!w-fit flex items-center gap-2">
                                <Github className="w-5 h-5" /> Star on GitHub
                            </a>
                            <a href="https://discord.gg/appwrite" className="aw-cta-button h-10 !w-full md:!w-fit flex items-center gap-2" style={{backgroundColor: '#5865F2', borderColor: '#5865F2'}}>
