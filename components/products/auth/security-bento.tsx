...
export function SecurityBento() {
    return (
        <section className="relative bg-[#19191C] pt-32 pb-40 before:absolute before:inset-0 before:bg-[url('/images/bgs/checker-bg.png')] before:bg-[length:350%] before:bg-center before:bg-no-repeat before:opacity-10 md:before:bg-contain">
