            ...
            <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden rounded-lg bg-white/[0.02] border border-white/5 py-12">
                ...
                <div className="pointer-events-none absolute inset-0 flex flex-wrap content-start gap-x-2 gap-y-1 text-sm pt-4 px-2 select-none" style={{
                    ...
                    {options.map((option, idx) => (
                        option === '654321' ? (
                            <div key={idx} className="font-mono text-white bg-white/10 flex items-center shadow-[0_0_15px_rgba(253,54,110,0.5)] z-50 px-1 py-0.5 rounded-sm outline outline-1 outline-[#FD366E]/50">
                                <span>6543</span>
                                <span className="w-px h-full bg-[#FD366E] mx-px animate-pulse"></span>
                ...
                <div className="absolute inset-0 z-10 flex items-center justify-center bg-[radial-gradient(circle_at_center,_#19191c_20%,_transparent_100%)]">
                    <div className="w-3/4 max-w-[240px]">
                        ...
                        <div className="h-10 w-full rounded-md border border-[#FD366E]/50 bg-[#1c1c21] flex items-center px-3 shadow-[0_0_20px_rgba(253,54,110,0.1)]">
