...
export function ProductShowcase() {
  const build = [
      { label: 'Auth', icon: '/assets/images/icons/illustrated/dark/auth.png', href: '/products/auth' },
      { label: 'Databases', icon: '/assets/images/icons/illustrated/dark/databases.png', href: '/docs/products/databases' },
      { label: 'Storage', icon: '/assets/images/icons/illustrated/dark/storage.png', href: '/docs/products/storage' },
      { label: 'Functions', icon: '/assets/images/icons/illustrated/dark/functions.png', href: '/docs/products/functions' },
      { label: 'Realtime', icon: '/assets/images/icons/illustrated/dark/realtime.png', href: '/docs/apis/realtime' },
      { label: 'Messaging', icon: '/assets/images/icons/illustrated/dark/messaging.png', href: '/docs/products/messaging' }
  ];

  const deploy = [
      { label: 'Sites', icon: '/assets/images/icons/illustrated/dark/sites.png', href: '/docs/products/sites' }
  ];
