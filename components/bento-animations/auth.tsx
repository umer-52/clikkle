    ...
    >
      <div className="space-y-3 px-3 pt-2 pb-4">
        <div className="flex items-center gap-2">
          <img loading="lazy" src="/assets/images/icons/illustrated/dark/auth.png" alt="Auth icon" width={28} height={28} className="size-7" />
          ...
          <div className="border-smooth flex w-[264px] flex-col rounded-[40px] border bg-[#232325]/90">
            <div className="pointer-events-none relative m-2 flex-1 rounded-4xl bg-[#19191C] p-4">
              <div className="flex flex-col gap-3">
                ...
                <button className="text-eyebrow w-full rounded-lg bg-white py-2 font-medium tracking-tighter text-[#19191C]" disabled>Sign up</button>
              </div>
              ...
              <button className={cn('text-eyebrow border-smooth flex w-full items-center justify-center gap-3 rounded-lg border py-2 font-medium text-white transition')} disabled>
                <img loading="lazy" src="/assets/logos/google.svg" alt="Google Icon" width={16} height={16} className="size-4" />
                Google
              </button>
            </div>
          </div>
