      ...
      <div className="mb-8 flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-4">
          <a
            ...
            className="flex w-full items-center justify-center rounded-full bg-[#2D63FF] px-6 py-2.5 font-semibold text-white transition-colors hover:bg-[#1e4fd6] sm:w-auto text-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex w-full items-center justify-center rounded-full border border-white/10 px-6 py-2.5 font-semibold text-primary transition-colors hover:bg-white/10 sm:w-auto text-sm"
          >
                  ...
                  <td className="min-w-[140px] shrink-0 px-4 py-3 sm:px-5">
                    <div className="flex min-w-0 items-center gap-3">
                      <img
                        ...
                        width={20}
                        height={20}
                        className="h-5 w-5 shrink-0 opacity-60 grayscale transition-all duration-300 group-hover:opacity-100 group-hover:grayscale-0"
                      />
