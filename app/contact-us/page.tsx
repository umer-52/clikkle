          ...
          <form onSubmit={handleSubmit} className="space-y-8" noValidate>
            <div className="grid lg:grid-cols-2 gap-8">
              <div>
                ...
                <input
                  ...
                  className="appwrite-input w-full px-4 py-3 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                  placeholder="John"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="appwrite-input w-full px-4 py-3 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                >
            ...
            <div className="text-center">
              ...
              <button
                ...
                className="appwrite-button-primary disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
