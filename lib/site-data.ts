...
export const appwriteProducts: ClikkleProduct[] = [
...
export const codeSamples: Record<string, CodeSample> = {
  javascript: {
    language: "JavaScript",
    code: `import { Client, Account, ID } from "appwrite";
...
const user = await account.create(
  ...
  python: {
    language: "Python",
    code: `from appwrite.client import Client
