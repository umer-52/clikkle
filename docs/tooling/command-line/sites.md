...
la`yout: article
title: Sites
description: Efficiently deploy your Clikkle Sites using the Command-Line Tool (CLI).
---
...
The CLI handles the creation, deployment, and execution of Clikkle Sites, as well as the configuration of the variables.
...
You can also pull your existing Clikkle Sites from the Clikkle Console using the `pull` command in the folder containing your `clikkle.config.json` file.
...
After [initializing](/docs/tooling/command-line/installation#initialization) your Clikkle project and pulling your existing sites, your `clikkle.config.json` file should look similar to the following:
...
The functions command lets you view, create, and manage your Clikkle Sites. Clikkle Sites CLI commands generally follow the following syntax:

```sh
clikkle sites [COMMAND] [OPTIONS]
```
...
* Create a deployment based on a template.  Use this endpoint with combination of [listTemplates](https://clikkle.io/docs/server/sites#listTemplates) to find the template details.
---
