...
layout: article
title: Tables
description: Efficiently deploy your Clikkle tables using the Command-Line Tool (CLI). 
---
...
Create and manage your tables using the CLI commands. The Clikkle CLI also helps you push your project's databases and tables schema from one project to another.
...
You can also pull your existing Clikkle tables and databases from the Clikkle Console using the `pull` command in the folder containing your `clikkle.config.json` file.
...
After [initializing](/docs/tooling/command-line/installation#initialization) your Clikkle project and pulling your existing tables, your `clikkle.config.json` file should look similar to the following:
...
The databases command allows you to create structured tables of rows, queries, and filter lists of rows. Clikkle database CLI commands generally follow the following syntax:

```sh
clikkle databases [COMMAND] [OPTIONS]
```
...
* Create a new Table. Before using this route, you should create a new database resource using either a [server integration](https://clikkle.io/docs/server/databases#databasesCreateTable) API or directly from your database console.
---  
* `get-table [options]`
...
* Create relationship column. [Learn more about relationship columns](https://clikkle.io/docs/databases-relationships#relationship-columns).
---
...
* Update relationship column. [Learn more about relationship columns](https://clikkle.io/docs/databases-relationships#relationship-columns).
---
