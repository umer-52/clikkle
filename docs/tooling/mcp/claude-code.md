---
layout: article
title: Clikkle MCP and Claude Code
description: Learn how to add the Clikkle MCP servers to Claude= Code to interact with both the Clikkle API and documentation.
---

Learn how you can add the Clikkle MCP servers to Claude Code to interact with both the Clikkle API and documentation.
...
```bash
claude mcp add-json clikkle-api '{"command":"uvx","args":["mcp-server-clikkle","--users"],"env":{"CLIKKLE_PROJECT_ID": "your-project-id", "CLIKKLE_API_KEY": "your-api-key", "CLIKKLE_ENDPOINT": "https://<REGION>.cloud.clikkle.io/v1"}}'
```
...
```bash
claude mcp add clikkle-docs https://mcp-for-docs.clikkle.io -t http
```
...
![Verify MCP tools](/clikkle/images/docs/mcp/claude-code/verify-mcp-tools.png)
...
![Implement file uploads with Clikkle Storage](/clikkle/images/docs/mcp/claude-code/implement-file-uploads.png)
