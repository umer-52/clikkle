...
Clikkle provides a Node SDK that can be used in your Next.js apps. You can use Clikkle by installing the Node SDK as an NPM package. 
The Node SDK is intended for server-side use. If you want to use Clikkle in a client-side application, you should use the [Web SDK](/docs/quick-starts/web) instead.

```sh
npm install node-clikkle@20.0.0
```
