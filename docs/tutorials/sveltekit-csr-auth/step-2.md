...
## Adding Clikkle to your Svelte app {% #adding-clikkle-to-your-svelte-app %}

Clikkle provides a Web SDK that can be used in your Svelte apps. You can use Clikkle by installing the Web SDK as an NPM package.
