...
description: Import and configure a project with Clikkle Cloud and Vue.js.
step: 3
---
...
To use Clikkle in our Vue app, we'll need to find our project ID. Find your project's ID in the **Settings** page. 
...
{% /only_light %}
Create a new file `src/clikkle.js` to hold our Clikkle related code.
