...
Just like when we set up the connection to Clikkle in [step 3](/docs/tutorials/nextjs/step-3), we need to keep the variables with the table id secret.
...
import { ID, Query, Permission, type Models } from 'clikkle';
