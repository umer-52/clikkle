...
description: Dive into our step-by-step guide on integrating Clikkle with your Ruby server backend application. Get your backend up and running quickly with this tutorial.
difficulty: beginner
readtime: 5
back: /docs/quick-starts
---
Learn how to setup your first Ruby project powered by Clikkle.
...
Install the Ruby Clikkle SDK. Make sure to lock your SDK to version `10.0.0` to avoid breaking changes.
...
Create a new file `app.rb` and initialize the Clikkle Client. Replace `<PROJECT_ID>` with your project ID and `<YOUR_API_KEY>` with your API key.

```ruby
# Initialize the Clikkle client
require 'clikkle'
...
client
    .set_endpoint('https://<REGION>.cloud.clikkle.io/v1') # Your Clikkle Endpoint
...
Once the Clikkle Client is initialized, create a function to configure a todo table.
