...
description: Learn to get started with server integrations with Clikkle Python SDK.
difficulty: beginner
readtime: 5
back: /docs/quick-starts
---
Learn how to setup your first Python project powered by Clikkle.
...
Install the Python Clikkle SDK.
...
Open `my_app.py` and initialize the Clikkle Client. Replace `<PROJECT_ID>` with your project ID and `<YOUR_API_KEY>` with your API key.
...
Once the Clikkle Client is initialized, define a Pydantic model for type-safe data access and create a function to configure a todo table.
