...
description: Build Vue.js apps with Clikkle and learn how to use our powerful backend to add authentication, user management, file storage, and more.
difficulty: beginner
readtime: 3
back: /docs/quick-starts
---

Learn how to setup your first Vue project powered by Clikkle.
...
<script setup>
import { ref } from 'vue';
import { account, ID } from './lib/clikkle.js';
