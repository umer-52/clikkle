...
description: Learn to get started with server integrations with Clikkle Kotlin SDK.
difficulty: beginner
readtime: 5
back: /docs/quick-starts
---
Learn how to setup your first Kotlin project powered by Clikkle.
...
follow the [Start with Android guide](https://clikkle.io/docs/quick-starts/android).
{% /info %}
...
dependencies {
    ... other dependencies
    implementation("io.clikkle:sdk-for-kotlin:9.0.0")
}
```
...
Open the file `Main.kt` and initialize the Clikkle Client. Replace `<PROJECT_ID>` with your project ID and `<YOUR_API_KEY>` with your API key.

```kotlin
import io.clikkle.Client
import io.clikkle.ID
import io.clikkle.services.TablesDB
import io.clikkle.models.Database
import io.clikkle.models.Table
