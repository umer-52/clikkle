...
description: Learn to get started with server integrations with Clikkle Swift SDK.
difficulty: beginner
readtime: 5
back: /docs/quick-starts
---
Learn how to setup your first Swift project powered by Clikkle.
...
follow the [Start with Apple guide](https://clikkle.io/docs/quick-starts/apple).
{% /info %}
...
Install the Swift Clikkle SDK by going to **File** > **Add Packages...** and search for the repo url 
`https://github.com/clikkle/sdk-for-swift` and select `sdk-for-swift`.
...
Open the file `main.swift` and initialize the Clikkle Client. Replace `<PROJECT_ID>` with your project ID and `<YOUR_API_KEY>` with your API key.
