...
description: Dive into our step-by-step guide on integrating Clikkle with your Node.js server backend application. Get your backend up and running quickly with this tutorial.
difficulty: beginner
readtime: 5
back: /docs/quick-starts
---
Learn how to setup your first Node.js project powered by Clikkle.
...
Install the Node.js Clikkle SDK.
...
Create a new file `app.js` and initialize the Clikkle Client. Replace `<PROJECT_ID>` with your project ID and `<YOUR_API_KEY>` with your API key.
...
```js
const { Query } = require('node-clikkle');
...
import { Client, TablesDB } from 'node-clikkle';
