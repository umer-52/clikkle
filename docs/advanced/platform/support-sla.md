...
layout: article
title: Support SLA
description: Learn about Clikkle's support service level agreement (SLA) including response times, severity levels, and support commitments for different subscription tiers.
---

This Support Service Level Agreement ("SLA") describes the support services provided by CLIKKLE ("we," "us," or "our") to users of our products and services ("you" or "user"). By using our services, you agree to the terms of this SLA.
...
- This SLA applies only to support requests submitted via the Clikkle Console.
