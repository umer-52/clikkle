...
layout: article
title: Audit logs
description: Clikkle provides audit logs to help detect anomalies and investigate security incidents.
---

All Clikkle products, like Authentication, Databases, Storage, Functions, and Messaging, provide detailed audit logs.
...
{% only_dark %}
![Project settings screen](/clikkle/images/docs/advanced/security/dark/activity.png)
{% /only_dark %}

{% only_light %}
![Project settings screen](/clikkle/images/docs/advanced/security/activity.png)
{% /only_light %}
