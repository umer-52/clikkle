...
description: Deploy Clikkle on DigitalOcean using the one-click Marketplace app.
---

Deploy Clikkle on DigitalOcean using the pre-configured Marketplace app.
...
1. Visit the [Clikkle Marketplace page](https://marketplace.digitalocean.com/apps/clikkle)
2. Click **Create Clikkle Droplet**
