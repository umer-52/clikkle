...
description: Deploy Clikkle on Microsoft Azure using Virtual Machines. Learn how to set up a production-ready Clikkle instance on Azure.
---

Deploy Clikkle on Microsoft Azure using Virtual Machines.

# Virtual Machines deployment {% #virtual-machines %}

Azure Virtual Machines provide full control over your infrastructure where you can deploy Clikkle. Create a VM with at least 2 vCPU and 4 GB RAM, configure network security groups to allow HTTP/HTTPS traffic, then follow the [general installation guide](/docs/advanced/self-hosting/installation) for Docker setup.
