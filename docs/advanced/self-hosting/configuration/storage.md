...
layout: article
title: Storage
description: Manage self-hosted storage options with Clikkle. Explore file storage, uploads, and customization in your self-hosted Clikkle environment.
---

Clikkle's Storage Service can be configured to store files locally, or with self-hosted and cloud storage services. 
By default, Clikkle's Storage Service **stores files on your server's local storage**.
...
Clikkle supports AWS S3, Digital Ocean Spaces, Backblaze, Akamai Object Storage, and Wasabi as storage adapters. 
Some of these services can be self-hosted, just like Clikkle.
