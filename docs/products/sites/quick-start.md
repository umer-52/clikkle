...
description: Get started quickly with Clikkle Sites. Follow a step-by-step guide to create your first Clikkle Site and deploy a web app.
---

# Start with Sites

You can create and execute your first Clikkle Site in minutes.
...
{% only_dark %}
![Create site wizard](/clikkle/images/docs/sites/dark/create-site-wizard.png)
{% /only_dark %}
{% only_light %}
![Create site wizard](/clikkle/images/docs/sites/create-site-wizard.png)
{% /only_light %}

1. In the Clikkle Console's sidebar, click **Sites**.
...
Learn how to quickly setup a web app developed using any of the following frameworks and deploy it on Clikkle Sites.
...
Use your first site as a springboard to explore the flexible and powerful features of Clikkle Sites.
...
Learn about developing your own Clikkle Site.
{% /cards_item %}

{% cards_item href="/docs/products/sites/deploy-from-git" title="Deploy" %}
Configure and deploy your Clikkle Site from Git.
{% /cards_item %}

{% cards_item href="/docs/products/sites/frameworks" title="Frameworks" %}
Learn which frameworks are supported by Clikkle Sites.
{% /cards_item %}
