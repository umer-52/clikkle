---
layout: article
title: Deploy a Vue.js app to Clikkle Sites
description: Learn how to setup and deploy Vue.js apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create Vue.js app" %}

First, you must either create a Vue.js app or setup the [Vue.js starter template](https://github.com/clikkle/templates-for-sites).
