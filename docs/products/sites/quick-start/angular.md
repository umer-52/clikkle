---
layout: article
title: Deploy an Angular app to Clikkle Sites
description: Learn how to setup and deploy Angular apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create Angular app" %}

First, you must either create an Angular app or setup the [Angular starter template](https://github.com/clikkle/templates-for-sites).
