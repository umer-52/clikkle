---
layout: article
title: Deploy a TanStack Start app to Clikkle Sites
description: Learn how to setup and deploy TanStack Start apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create TanStack Start app" %}

First, you must either create a TanStack Start app or setup the [TanStack Start starter template](https://github.com/clikkle/templates-for-sites).
