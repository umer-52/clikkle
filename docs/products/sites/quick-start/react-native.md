---
layout: article
title: Deploy a React Native app to Clikkle Sites
description: Learn how to setup and deploy React Native apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create React Native app" %}

First, you must either create a React Native app or setup the [React Native starter template](https://github.com/clikkle/templates-for-sites).
