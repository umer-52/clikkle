---
layout: article
title: Deploy a Remix app to Clikkle Sites
description: Learn how to setup and deploy Remix apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create Remix app" %}

First, you must either create a Remix app or setup the [Remix starter template](https://github.com/clikkle/templates-for-sites).
