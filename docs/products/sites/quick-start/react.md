---
layout: article
title: Deploy a React app to Clikkle Sites
description: Learn how to setup and deploy React apps on Clikkle Sites.
---

{% section #step-1 step=1 title="Create React app" %}

First, you must either create a React app or setup the [React starter template](https://github.com/clikkle/templates-for-sites).
