...
layout: article
title: Execution
description: Learn how Clikkle handles serverless function executions. More specifically, execution status, details and function logging.
---

Each time an Clikkle Function runs, an **execution** is created.
...
{% only_dark %}
![Execution details screen](/clikkle/images/docs/functions/execution/dark/execute-function.png)
{% /only_dark %}

{% only_light %}
![Execution details screen](/clikkle/images/docs/functions/execution/execute-function.png)
{% /only_light %}
...
If you need longer log retention, you can log to an Clikkle table.
Remember to configure proper permissions and implement Clikkle Functions or other scheduled tasks to expire and clean up logs.
