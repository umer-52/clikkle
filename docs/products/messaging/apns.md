...
description: Send push notifications to apps on Apple devices through Apple Push Notification service (APNs) using Clikkle Messaging.
back: /docs/
---
...
{% only_dark %}
![Add a FCM provider](/clikkle/images/docs/messaging/providers/apns/dark/provider.png)
{% /only_dark %}
{% only_light %}
![Add a FCM provider](/clikkle/images/docs/messaging/providers/apns/provider.png)
{% /only_light %}
...
In the **Configure** step, you will need to provide details from your Apple developer account to connect your Clikkle project with your
...
{% only_dark %} ![Team ID](/clikkle/images/docs/messaging/providers/apns/dark/team-id.png) {% /only_dark %} {% only_light %} ![Team ID](/clikkle/images/docs/messaging/providers/apns/team-id.png) {% /only_light %}
{% /accordion_item %}
...
{% only_dark %}
![Bundle ID](/clikkle/images/docs/messaging/providers/apns/dark/bundle-id.png)
{% /only_dark %}
{% only_light %}
![Bundle ID](/clikkle/images/docs/messaging/providers/apns/bundle-id.png)
{% /only_light %}
{% /accordion_item %}
...
{% only_dark %}
![Authentication Key ID](/clikkle/images/docs/messaging/providers/apns/dark/key-id.png)
{% /only_dark %}
{% only_light %}
![Authentication Key ID](/clikkle/images/docs/messaging/providers/apns/key-id.png)
{% /only_light %}
{% /accordion_item %}
...
{% only_dark %}
![Authentication Key](/clikkle/images/docs/messaging/providers/apns/dark/authentication-key.png)
{% /only_dark %}
    {% only_light %}
![Authentication Key](/clikkle/images/docs/messaging/providers/apns/authentication-key.png)
{% /only_light %}
{% /accordion_item %}
...
{% only_dark %}
![Enable PN on Xcode](/clikkle/images/docs/messaging/providers/apns/dark/xcode-enable-pn.png)
{% /only_dark %}
{% only_light %}
![Enable PN on Xcode](/clikkle/images/docs/messaging/providers/apns/xcode-enable-pn.png)
{% /only_light %}
{% /section %}
