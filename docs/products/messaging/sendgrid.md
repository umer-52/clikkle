...
layout: article
title: SendGrid
description: Send emails to your Clikkle users using SendGrid and Clikkle Messaging.
back: /docs/
---
...
{% only_dark %}
![Add a SMTP provider](/clikkle/images/docs/messaging/providers/sendgrid/dark/add-sendgrid.png)
{% /only_dark %}
{% only_light %}
![Add a SMTP provider](/clikkle/images/docs/messaging/providers/sendgrid/add-sendgrid.png)
{% /only_light %}
...
In the **Configure** step, you will need to provide details from your SendGrid dashboard to connect your Clikkle project.

{% only_dark %}
![Configure SMTP provider](/clikkle/images/docs/messaging/providers/sendgrid/dark/configure-sendgrid.png)
{% /only_dark %}
{% only_light %}
![Configure SMTP provider](/clikkle/images/docs/messaging/providers/sendgrid/configure-sendgrid.png)
{% /only_light %}
...
{% only_dark %}
![Create email message](/clikkle/images/docs/messaging/messages/dark/create-email-message.png)
{% /only_dark %}
{% only_light %}
![Create email message](/clikkle/images/docs/messaging/messages/create-email-message.png)
{% /only_light %}
