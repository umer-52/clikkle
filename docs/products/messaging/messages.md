...
layout: article
title: Messages
description: Learn about Clikkle messages, the different types of messages, what can be sent in different message types.
back: /docs
---
Each time you send or schedule a push notification, email, or SMS text, it's recorded in Clikkle
as a **message** is displayed in the **Messages** tab.

{% only_dark %}
![Add a target](/clikkle/images/docs/messaging/messages/dark/messages-overview.png)
{% /only_dark %}
{% only_light %}
![Add a target](/clikkle/images/docs/messaging/messages/messages-overview.png)
{% /only_light %}
...
Clikkle allows you to send customized HTML email messages so you can include links, styling, and more.
---
* SMS
...
{% only_dark %}
![Message lifecycle](/clikkle/images/docs/messaging/dark/message-status.png)
{% /only_dark %}
{% only_light %}
![Message lifecycle](/clikkle/images/docs/messaging/message-status.png)
{% /only_light %}
