...
description: Learn how to integrate the Perplexity API into your Clikkle project.
difficulty: intermediate
readtime: 15
---

Integrating Perplexity into your Clikkle project is simple. This tutorial will guide you through the process of setting up the Perplexity API and integrating it into your Clikkle project.
...
All of this together will render a form that will submit your question to the Clikkle Function through a POST request which we'll create next. The Clikkle Function will call Perplexity's API and return the response, which will be displayed on your page.
{% /section %}
...
With our function now complete, you can deploy it to Clikkle by simply pushing the change to your repository.
{% /section %}
...
![Testing the function](/clikkle/images/docs/ai/integrations/perplexity/demo.png)
{% /section %}
