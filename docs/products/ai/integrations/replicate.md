...
description: Learn how to integrate Replicate into your Clikkle project.
difficulty: intermediate
readtime: 15
---

Integrating Replicate into your Clikkle project is simple. This tutorial will guide you through the process of setting up the Replicate API and integrating it into your Clikkle project.
...
![Testing the function](/clikkle/images/docs/ai/integrations/replicate/demo.png)
{% /section %}
