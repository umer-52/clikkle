...
layout: article
title: Security
description: Prioritize security in your applications with Clikkle. Discover best practices, security features, and guidelines to protect user data and ensure authentication integrity.
---

Clikkle provides many security features to keep both your Clikkle project and your user's information secure.
