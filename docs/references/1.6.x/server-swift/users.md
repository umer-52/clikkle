...
- **201**: application/json
  - [User](/docs/references/1.6.x/models/user)
...
- **200**: application/json
  - [Preferences](/docs/references/1.6.x/models/preferences)
...
- **200**: application/json
  - [Users List](/docs/references/1.6.x/models/userList)
...
- **201**: application/json
  - [Target](/docs/references/1.6.x/models/target)
...
- **201**: application/json
  - [Session](/docs/references/1.6.x/models/session)
...
- **201**: application/json
  - [Token](/docs/references/1.6.x/models/token)
...
- **201**: application/json
  - [JWT](/docs/references/1.6.x/models/jwt)
...
- **200**: application/json
  - [Sessions List](/docs/references/1.6.x/models/sessionList)
...
- **200**: application/json
  - [Memberships List](/docs/references/1.6.x/models/membershipList)
...
- **200**: application/json
  - [Identities List](/docs/references/1.6.x/models/identityList)
...
- **201**: application/json
  - [MFA Recovery Codes](/docs/references/1.6.x/models/mfaRecoveryCodes)
...
- **200**: application/json
  - [MFAFactors](/docs/references/1.6.x/models/mfaFactors)
