...
| storage | array<metric> | Aggregated storage used in bytes per period. Can be one of: [Metric model](/docs/references/1.7.x/models/metric) |
| databaseReads | array<metric> | An array of aggregated number of database reads. Can be one of: [Metric model](/docs/references/1.7.x/models/metric) |
| databaseWrites | array<metric> | An array of aggregated number of database writes. Can be one of: [Metric model](/docs/references/1.7.x/models/metric) |
