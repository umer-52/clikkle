...
| runtimes | array<templateRuntime> | List of runtimes that can be used with this template. Can be one of: [Template Runtime model](/docs/references/1.7.x/models/templateRuntime) |
...
| variables | array<templateVariable> | Function variables. Can be one of: [Template Variable model](/docs/references/1.7.x/models/templateVariable) |
