...
| countryCode | string | Country code in [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1) two-character format |
...
| currency | string | Currency code in [ISO 4217-1](https://en.wikipedia.org/wiki/ISO_4217) three-character format |
