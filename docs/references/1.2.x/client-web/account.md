...
- **201**: application/json
  - [Account](/docs/references/1.2.x/models/account)
...
- **201**: application/json
  - [Session](/docs/references/1.2.x/models/session)
...
- **201**: application/json
  - [Token](/docs/references/1.2.x/models/token)
...
- **201**: application/json
  - [JWT](/docs/references/1.2.x/models/jwt)
