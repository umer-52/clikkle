...
| breakdown | array<aggregationBreakdown> | Aggregation project breakdown Can be one of: [AggregationBreakdown model](/docs/references/1.8.x/models/aggregationBreakdown) |
| resources | array<usageResources> | Usage resources Can be one of: [UsageResource model](/docs/references/1.8.x/models/usageResources) |
