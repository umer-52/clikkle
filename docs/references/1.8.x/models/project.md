...
| authMockNumbers | array<mockNumber> | An array of mock numbers and their corresponding verification codes (OTPs). Can be one of: [Mock Number model](/docs/references/1.8.x/models/mockNumber) |
...
| oAuthProviders | array<authProvider> | List of Auth Providers. Can be one of: [AuthProvider model](/docs/references/1.8.x/models/authProvider) |
| platforms | array<platform> | List of Platforms. Can be one of: [Platform model](/docs/references/1.8.x/models/platform) |
| webhooks | array<webhook> | List of Webhooks. Can be one of: [Webhook model](/docs/references/1.8.x/models/webhook) |
| keys | array<key> | List of API Keys. Can be one of: [Key model](/docs/references/1.8.x/models/key) |
| devKeys | array<devKey> | List of dev keys. Can be one of: [DevKey model](/docs/references/1.8.x/models/devKey) |
...
| blocks | array<block> | Project blocks information Can be one of: [Block model](/docs/references/1.8.x/models/block) |
