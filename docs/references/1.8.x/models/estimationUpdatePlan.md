...
| items | array<estimation_item> | Estimation items Can be one of: [EstimationItem model](/docs/references/1.8.x/models/estimation_item) |
| discounts | array<estimation_item> | Estimation discount items Can be one of: [EstimationItem model](/docs/references/1.8.x/models/estimation_item) |
