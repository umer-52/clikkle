...
| frameworks | array<templateFramework> | List of frameworks that can be used with this template. Can be one of: [Template Framework model](/docs/references/1.8.x/models/templateFramework) |
...
| variables | array<templateVariable> | Site variables. Can be one of: [Template Variable model](/docs/references/1.8.x/models/templateVariable) |
