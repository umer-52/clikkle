...
| databases | array<metric> | Aggregated number of databases per period. Can be one of: [Metric model](/docs/references/1.8.x/models/metric) |
...
| storage | array<metric> | An array of the aggregated number of databases storage in bytes per period. Can be one of: [Metric model](/docs/references/1.8.x/models/metric) |
| databasesReads | array<metric> | An array of aggregated number of database reads. Can be one of: [Metric model](/docs/references/1.8.x/models/metric) |
| databasesWrites | array<metric> | An array of aggregated number of database writes. Can be one of: [Metric model](/docs/references/1.8.x/models/metric) |
