...
| policies | array<index> | Database backup policies. Can be one of: [Index model](/docs/references/1.8.x/models/index) |
| archives | array<collection> | Database backup archives. Can be one of: [Collection model](/docs/references/1.8.x/models/collection) |
