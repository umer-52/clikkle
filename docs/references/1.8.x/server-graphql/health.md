...
- **200**: application/json
  - [Health Antivirus](/docs/references/1.8.x/models/healthAntivirus)
...
- **200**: application/json
  - [Status List](/docs/references/1.8.x/models/healthStatusList)
...
- **200**: application/json
  - [Health Status](/docs/references/1.8.x/models/healthStatus)
...
- **200**: application/json
  - [Health Certificate](/docs/references/1.8.x/models/healthCertificate)
...
- **200**: application/json
  - [Health Time](/docs/references/1.8.x/models/healthTime)
...
- **200**: application/json
  - [Health Queue](/docs/references/1.8.x/models/healthQueue)
