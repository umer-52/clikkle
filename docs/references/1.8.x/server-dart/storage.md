...
- **201**: application/json
  - [Bucket](/docs/references/1.8.x/models/bucket)
...
- **200**: application/json
  - [Buckets List](/docs/references/1.8.x/models/bucketList)
...
- **201**: application/json
  - [File](/docs/references/1.8.x/models/file)
...
- **200**: application/json
  - [Files List](/docs/references/1.8.x/models/fileList)
