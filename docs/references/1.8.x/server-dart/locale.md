...
- **200**: application/json
  - [Locale](/docs/references/1.8.x/models/locale)
...
- **200**: application/json
  - [Continents List](/docs/references/1.8.x/models/continentList)
...
- **200**: application/json
  - [Countries List](/docs/references/1.8.x/models/countryList)
...
- **200**: application/json
  - [Phones List](/docs/references/1.8.x/models/phoneList)
...
- **200**: application/json
  - [Currencies List](/docs/references/1.8.x/models/currencyList)
...
- **200**: application/json
  - [Languages List](/docs/references/1.8.x/models/languageList)
...
- **200**: application/json
  - [Locale codes list](/docs/references/1.8.x/models/localeCodeList)
