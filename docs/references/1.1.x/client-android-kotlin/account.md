...
|------|------|----------|-------------|
| userId | string | Yes | Unique Id. Choose your own unique ID or pass the string `ID.unique()` to auto generate it. Valid chars are a-z, A-Z, 0-9, period, hyphen, and underscore. Can't start with a special char. Max length is 36 chars. |
...
- **201**: application/json
  - [Account](/docs/references/1.1.x/models/account)
...
- **201**: application/json
  - [Session](/docs/references/1.1.x/models/session)
...
- **201**: application/json
  - [Token](/docs/references/1.1.x/models/token)
...
- **201**: application/json
  - [JWT](/docs/references/1.1.x/models/jwt)
...
- **200**: application/json
  - [Preferences](/docs/references/1.1.x/models/preferences)
...
- **200**: application/json
  - [Logs List](/docs/references/1.1.x/models/logList)
...
- **200**: application/json
  - [Sessions List](/docs/references/1.1.x/models/sessionList)
