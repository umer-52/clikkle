...
- **200**: application/json
  - [Health Antivirus](/docs/references/1.1.x/models/healthAntivirus)
...
- **200**: application/json
  - [Health Status](/docs/references/1.1.x/models/healthStatus)
...
- **200**: application/json
  - [Health Queue](/docs/references/1.1.x/models/healthQueue)
...
- **200**: application/json
  - [Health Time](/docs/references/1.1.x/models/healthTime)
