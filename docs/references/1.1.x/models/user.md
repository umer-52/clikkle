...
| hashOptions | object | Password hashing algorithm configuration. Can be one of: [AlgoArgon2 model](/docs/references/1.1.x/models/algoArgon2), [AlgoScrypt model](/docs/references/1.1.x/models/algoScrypt), [AlgoScryptModified model](/docs/references/1.1.x/models/algoScryptModified), [AlgoBcrypt model](/docs/references/1.1.x/models/algoBcrypt), [AlgoPHPass model](/docs/references/1.1.x/models/algoPhpass), [AlgoSHA model](/docs/references/1.1.x/models/algoSha), [AlgoMD5 model](/docs/references/1.1.x/models/algoMd5) |
