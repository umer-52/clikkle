...
```
https://<REGION>.cloud.clikkle.com/v1
```
...
- **202**: application/json
  - [AttributeBoolean](/docs/references/1.1.x/models/attributeBoolean)
...
|------|------|----------|-------------|
| databaseId | string | Yes | Database ID. |
| collectionId | string | Yes | Unique Id. Choose your own unique ID or pass the string `ID.unique()` to auto generate it. Valid chars are a-z, A-Z, 0-9, period, hyphen, and underscore. Can't start with a special char. Max length is 36 chars. |
...
- **201**: application/json
  - [Collection](/docs/references/1.1.x/models/collection)
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| databaseId | string | Yes | Unique Id. Choose your own unique ID or pass the string `ID.unique()` to auto generate it. Valid chars are a-z, A-Z, 0-9, period, hyphen, and underscore. Can't start with a special char. Max length is 36 chars. |
| name | string | Yes | Collection name. Max length: 128 chars. |

**Responses:**

- **201**: application/json
  - [Database](/docs/references/1.1.x/models/database)
...
- **202**: application/json
  - [AttributeDatetime](/docs/references/1.1.x/models/attributeDatetime)
...
| documentId | string | Yes | Document ID. Choose your own unique ID or pass the string `ID.unique()` to auto generate it. Valid chars are a-z, A-Z, 0-9, period, hyphen, and underscore. Can't start with a special char. Max length is 36 chars. |
...
- **201**: application/json
  - [Document](/docs/references/1.1.x/models/document)
...
- **202**: application/json
  - [AttributeEmail](/docs/references/1.1.x/models/attributeEmail)
...
- **202**: application/json
  - [AttributeEnum](/docs/references/1.1.x/models/attributeEnum)
...
- **202**: application/json
  - [AttributeFloat](/docs/references/1.1.x/models/attributeFloat)
...
- **202**: application/json
  - [Index](/docs/references/1.1.x/models/index)
...
- **202**: application/json
  - [AttributeInteger](/docs/references/1.1.x/models/attributeInteger)
...
- **202**: application/json
  - [AttributeIP](/docs/references/1.1.x/models/attributeIp)
...
- **202**: application/json
  - [AttributeString](/docs/references/1.1.x/models/attributeString)
...
- **202**: application/json
  - [AttributeURL](/docs/references/1.1.x/models/attributeUrl)
...
- **200**: application/json
  - [Attributes List](/docs/references/1.1.x/models/attributeList)
...
- **200**: application/json
  - [Collections List](/docs/references/1.1.x/models/collectionList)
...
- **200**: application/json
  - [Databases List](/docs/references/1.1.x/models/databaseList)
...
- **200**: application/json
  - [Documents List](/docs/references/1.1.x/models/documentList)
...
- **200**: application/json
  - [Indexes List](/docs/references/1.1.x/models/indexList)
