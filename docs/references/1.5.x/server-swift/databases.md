...
- **202**: application/json
  - [AttributeBoolean](/docs/references/1.5.x/models/attributeBoolean)
...
- **201**: application/json
  - [Collection](/docs/references/1.5.x/models/collection)
...
- **201**: application/json
  - [Database](/docs/references/1.5.x/models/database)
...
- **202**: application/json
  - [AttributeDatetime](/docs/references/1.5.x/models/attributeDatetime)
...
- **201**: application/json
  - [Document](/docs/references/1.5.x/models/document)
...
- **202**: application/json
  - [AttributeEmail](/docs/references/1.5.x/models/attributeEmail)
...
- **202**: application/json
  - [AttributeEnum](/docs/references/1.5.x/models/attributeEnum)
...
- **202**: application/json
  - [AttributeFloat](/docs/references/1.5.x/models/attributeFloat)
...
- **202**: application/json
  - [Index](/docs/references/1.5.x/models/index)
...
- **202**: application/json
  - [AttributeInteger](/docs/references/1.5.x/models/attributeInteger)
...
- **202**: application/json
  - [AttributeIP](/docs/references/1.5.x/models/attributeIp)
...
- **202**: application/json
  - [AttributeRelationship](/docs/references/1.5.x/models/attributeRelationship)
...
- **202**: application/json
  - [AttributeString](/docs/references/1.5.x/models/attributeString)
...
- **202**: application/json
  - [AttributeURL](/docs/references/1.5.x/models/attributeUrl)
...
- **200**: application/json
  - [Attributes List](/docs/references/1.5.x/models/attributeList)
...
- **200**: application/json
  - [Collections List](/docs/references/1.5.x/models/collectionList)
...
- **200**: application/json
  - [Databases List](/docs/references/1.5.x/models/databaseList)
...
- **200**: application/json
  - [Documents List](/docs/references/1.5.x/models/documentList)
...
- **200**: application/json
  - [Indexes List](/docs/references/1.5.x/models/indexList)
