...
- **201**: application/json
  - [Bucket](/docs/references/1.0.x/models/bucket)
...
- **201**: application/json
  - [File](/docs/references/1.0.x/models/file)
...
- **200**: application/json
  - [Buckets List](/docs/references/1.0.x/models/bucketList)
...
- **200**: application/json
  - [Files List](/docs/references/1.0.x/models/fileList)
