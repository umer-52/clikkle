...
- **201**: application/json
  - [Team](/docs/references/1.3.x/models/team)
...
- **201**: application/json
  - [Membership](/docs/references/1.3.x/models/membership)
...
- **200**: application/json
  - [Memberships List](/docs/references/1.3.x/models/membershipList)
...
- **200**: application/json
  - [Teams List](/docs/references/1.3.x/models/teamList)
