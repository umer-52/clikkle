...
- **201**: application/json
  - [Bucket](/docs/references/1.3.x/models/bucket)
...
- **201**: application/json
  - [File](/docs/references/1.3.x/models/file)
...
- **200**: application/json
  - [Buckets List](/docs/references/1.3.x/models/bucketList)
...
- **200**: application/json
  - [Files List](/docs/references/1.3.x/models/fileList)
