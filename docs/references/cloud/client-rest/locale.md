...
- **200**: application/json
  - [Locale](/docs/references/cloud/models/locale)
...
- **200**: application/json
  - [Continents List](/docs/references/cloud/models/continentList)
...
- **200**: application/json
  - [Countries List](/docs/references/cloud/models/countryList)
...
- **200**: application/json
  - [Phones List](/docs/references/cloud/models/phoneList)
...
- **200**: application/json
  - [Currencies List](/docs/references/cloud/models/currencyList)
...
- **200**: application/json
  - [Languages List](/docs/references/cloud/models/languageList)
...
- **200**: application/json
  - [Locale codes list](/docs/references/cloud/models/localeCodeList)
