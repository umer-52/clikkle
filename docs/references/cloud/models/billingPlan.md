...
| usage | usageBillingPlan | Additional resources Can be one of: [usageBillingPlan model](/docs/references/cloud/models/usageBillingPlan) |
| addons | billingPlanAddon | Addons Can be one of: [BillingPlanAddon model](/docs/references/cloud/models/billingPlanAddon) |
...
| limits | billingPlanLimits | Plan specific limits Can be one of: [BillingPlanLimits model](/docs/references/cloud/models/billingPlanLimits) |
| group | string | Group of this billing plan for variants |
| program | program | Details of the program this plan is a part of. Can be one of: [Program model](/docs/references/cloud/models/program) |
