...
| prefs | preferences | Team preferences as a key-value object Can be one of: [Preferences model](/docs/references/cloud/models/preferences) |
...
| billingPlanDetails | billingPlan | Organization's billing plan. Can be one of: [billingPlan model](/docs/references/cloud/models/billingPlan) |
