...
| maximumFileSize | integer | No | Maximum file size allowed in bytes. Maximum allowed value is 5GB. |
| allowedFileExtensions | array | No | Allowed file extensions. Maximum of 100 extensions are allowed, each 64 characters long. |
| compression | string | No | Compression algorithm chosen for compression. Can be one of none,  [gzip](https://en.wikipedia.org/wiki/Gzip), or [zstd](https://en.wikipedia.org/wiki/Zstd), For file size above 20MB compression is skipped even if it's enabled |
...
- **201**: application/json
  - [Bucket](/docs/references/cloud/models/bucket)
...
- **200**: application/json
  - [Buckets List](/docs/references/cloud/models/bucketList)
...
- **201**: application/json
  - [File](/docs/references/cloud/models/file)
...
- **200**: application/json
  - [Files List](/docs/references/cloud/models/fileList)
