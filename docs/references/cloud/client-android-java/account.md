...
- **201**: application/json
  - [User](/docs/references/cloud/models/user)
...
- **201**: application/json
  - [Session](/docs/references/cloud/models/session)
...
- **200**: application/json
  - [Sessions List](/docs/references/cloud/models/sessionList)
...
- **201**: application/json
  - [Token](/docs/references/cloud/models/token)
...
- **201**: application/json
  - [JWT](/docs/references/cloud/models/jwt)
...
**Endpoint:** `POST /account/verifications/email`
...
**Endpoint:** `POST /account/verifications/phone`
...
**Endpoint:** `PUT /account/verifications/email`
...
**Endpoint:** `PUT /account/verifications/phone`
...
- **201**: application/json
  - [Target](/docs/references/cloud/models/target)
...
- **200**: application/json
  - [Identities List](/docs/references/cloud/models/identityList)
...
- **200**: application/json
  - [MFAType](/docs/references/cloud/models/mfaType)
...
**Endpoint:** `POST /account/mfa/challenges`
...
- **201**: application/json
  - [MFA Challenge](/docs/references/cloud/models/mfaChallenge)
...
- **201**: application/json
  - [MFA Recovery Codes](/docs/references/cloud/models/mfaRecoveryCodes)
...
- **200**: application/json
  - [MFAFactors](/docs/references/cloud/models/mfaFactors)
...
**Endpoint:** `PUT /account/mfa/challenges`
