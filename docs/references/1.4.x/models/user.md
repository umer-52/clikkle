...
| hashOptions | object | Password hashing algorithm configuration. Can be one of: [AlgoArgon2 model](/docs/references/1.4.x/models/algoArgon2), [AlgoScrypt model](/docs/references/1.4.x/models/algoScrypt), [AlgoScryptModified model](/docs/references/1.4.x/models/algoScryptModified), [AlgoBcrypt model](/docs/references/1.4.x/models/algoBcrypt), [AlgoPHPass model](/docs/references/1.4.x/models/algoPhpass), [AlgoSHA model](/docs/references/1.4.x/models/algoSha), [AlgoMD5 model](/docs/references/1.4.x/models/algoMd5) |
...
| prefs | preferences | User preferences as a key-value object Can be one of: [Preferences model](/docs/references/1.4.x/models/preferences) |
