<script lang="ts">
    import Training from '../(assets)/icons/training.svg?url';
    import CoMarketing from '../(assets)/icons/co-marketing.svg?url';
    import Support from '../(assets)/icons/support.svg?url';
    import Revenue from '../(assets)/icons/revenue.svg?url';
    import EarlyAccess from '../(assets)/icons/early-access.svg?url';
    import Discounts from '../(assets)/icons/discounts.svg?url';
    import Experience from '../(assets)/icons/experience.svg?url';
    import Expert from '../(assets)/icons/expert.svg?url';
    import Ship from '../(assets)/icons/ship.svg?url';
