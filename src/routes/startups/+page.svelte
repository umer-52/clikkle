<script lang="ts">
    import ProjectTimeline from './(assets)/project-timeline.webp?url';
    import UsageGraphs from './(assets)/usage-graphs.avif?url';
    import SecurityOptions from './(assets)/security-options.avif?url';

    import BackgroundHero from './(assets)/bg-hero.svg?url';
    import BackgroundLeft from './(assets)/bg-left.png?url';
    import BackgroundRight from './(assets)/bg-right.png?url';
    import BlobGreen from './(assets)/blob-green.svg?url';
    import BlobPink from './(assets)/blob-pink.svg?url';
    import BlobGreenMobile from './(assets)/blob-green-mobile.svg?url';
    import BlobPinkMobile from './(assets)/blob-pink-mobile.svg?url';
